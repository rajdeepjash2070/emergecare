...
<div class="content">
    ...
    <a href="/register" class="btn"> Register now<span class="fas fa-chevron-right"></span> </a>
</div>
...
<div class="box-container row">
    ...
    <div class="box col-md-4" style={{width:"300px"}}>
        <img src={image1} alt=""/>
        <p className="text-center" style={{color:"white"}}>Rajdeep</p>
        <div class="stars">
...
<div class="credit"> created by <span><a href ="https://github.com/anurajkumar23">Anuraj kumar Rajdeep Jash Aditya Raj</a></span> | ©all rights reserved </div>
